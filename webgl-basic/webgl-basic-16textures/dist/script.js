/* 
  ...
  밉맵은 선형 보간에 의해 단계별 1/4 축소 이미지의 모음!!
    gl.generateMipmap(gl.TEXTURE_2D);
  
  createTexture()에서 이미 설정됨.
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
    
  WRAP 파라미터 설정: CLAMP_TO_EDGE, REPEAT, MIRRORED_REPEAT!!
  s 방향(u)에 대해 모서리 픽셀 반복
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    
  t 방향(v)에 대해 모서리 픽셀 반복
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
  ...
  MIN_FILTER 파라미터 설정
    ...
    NEAREST와 LINEAR는 큰 밉에서 픽셀 선택된다. 크기와 위치가 바뀌면서 픽셀도 달라질 수 있어 깜박임이 발생.
    NEAREST_MIPMAP_NEAREST와 LINEAR_MIPMAP_NEAREST는 다른 밉맵 선택에 대한 경계가 명확히 보인다.
    NEAREST_MIPMAP_LINEAR과 LINEAR_MIPMAP_LINEAR은 양쪽 밉에서 블렌딩하기에 부드러운 밉맵 경계가 보인다.
    LINEAR_MIPMAP_LINEAR가 가장 좋지만 가장 느리고 메모리도 많이 소모한다. 레트로 느낌을 원하면 NEAREST를 사용.
    밉맵 자체가 33%정도 메모리를 더 많이 사용. NEAREST나 LINEAR로 첫번째 밉만 사용으로 이를 제한.
...
(function main() {
  ...
  let o = { x: 182, y: 168, w: 145, h: 145 };
  // 큐브 각 면에 맞게 텍스처 좌표를 입력!!
  // prettier-ignore
  let texcoordData2 = [
    //front
    o.x+o.w*0, o.y+o.h*0,
    o.x+o.w*0, o.y+o.h*0+o.h,
    o.x+o.w*0+o.w, o.y+o.h*0,
    o.x+o.w*0, o.y+o.h*0+o.h,
    o.x+o.w*0+o.w, o.y+o.h*0+o.h,
    o.x+o.w*0+o.w, o.y+o.h*0,
    //back
    o.x+o.w*2, o.y+o.h*0,
    o.x+o.w*2, o.y+o.h*0+o.h,
    o.x+o.w*2+o.w, o.y+o.h*0,
    o.x+o.w*2, o.y+o.h*0+o.h,
    o.x+o.w*2+o.w, o.y+o.h*0+o.h,
    o.x+o.w*2+o.w, o.y+o.h*0,
    // left
    o.x+o.w*(-1), o.y+o.h*0,
    o.x+o.w*(-1), o.y+o.h*0+o.h,
    o.x+o.w*(-1)+o.w, o.y+o.h*0,
    o.x+o.w*(-1), o.y+o.h*0+o.h,
    o.x+o.w*(-1)+o.w, o.y+o.h*0+o.h,
    o.x+o.w*(-1)+o.w, o.y+o.h*0,
    // right
    o.x+o.w*1, o.y+o.h*0,
    o.x+o.w*1, o.y+o.h*0+o.h,
    ...
    // top
    o.x+o.w*0, o.y+o.h*(-1),
    o.x+o.w*0, o.y+o.h*(-1)+o.h,
    o.x+o.w*0+o.w, o.y+o.h*(-1),
    o.x+o.w*0, o.y+o.h*(-1)+o.h,
    o.x+o.w*0+o.w, o.y+o.h*(-1)+o.h,
    o.x+o.w*0+o.w, o.y+o.h*(-1),
    // bottom
    o.x+o.w*0, o.y+o.h*1,
    o.x+o.w*0, o.y+o.h*1+o.h,
  ...
  let convedTexcoordData = [];
  for (let i = 0; i < texcoordData2.length; i += 2) {
    convedTexcoordData.push(texcoordData2[i] / 639);
    convedTexcoordData.push(texcoordData2[i + 1] / 481);
  }

  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(convedTexcoordData),
    gl.STATIC_DRAW
  );
  ...
  let img = loadImage(mapImage, function () {
